...
<script type="text/javascript" src="{{url('/')}}/assets/js/jquery.plugin.min.js"></script>
<script type="text/javascript" src="{{url('/')}}/assets/js/jquery.countdown.min.js"></script>
<script type="text/javascript" src="{{url('/')}}/assets/js/jquery.timepicker.min.js"></script>