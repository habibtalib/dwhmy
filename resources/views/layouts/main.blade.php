                ...
                <div class="owl-carousel" data-owl-nav="0" data-owl-dots="1" data-owl-loop="1">
                        ...
                        <div class="coupon">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <div class="bg-transfer"><img src="assets/img/items/15.jpg" alt=""></div>
                                </div>
                                <div class="description">
                                    <h1>Relaxing Thai Massage</h1>
                                    <figure class="label label-default">From $60</figure>
                                    <figure class="location"><i class="fa fa-map-marker"></i>London</figure>
                                    <hr>
                                    <div class="count-down" data-countdown-year="2017" data-countdown-month="6" data-countdown-day="21"></div>
                    ...
                    <div class="slide center">
                        <div class="coupon">
                            <div class="wrapper">
                                <div class="image">
                                    <figure class="circle">-20%</figure>
                                    <div class="bg-transfer"><img src="assets/img/items/5.jpg" alt=""></div>
                                </div>
                                <div class="description">
                                    <h1>Dinner For Couple</h1>
                                    <figure class="label label-default">From $30</figure>
                                    <figure class="location"><i class="fa fa-map-marker"></i>New York</figure>
                                    <hr>
                                    <div class="count-down" data-countdown-year="2017" data-countdown-month="6" data-countdown-day="21"></div>
                                    <a href="detail.html" class="btn btn-default btn-framed btn-rounded">View Detail</a>
                                </div>
                    ...
                    <div class="slide center">
                        <div class="coupon">
                            <div class="wrapper">
                                <div class="image">
                                    <figure class="circle">-26%</figure>
                                    <div class="bg-transfer"><img src="assets/img/items/27.jpg" alt=""></div>
                                </div>
                                <div class="description">
                                    <h1>Weekend Trip to Venice</h1>
                                    <figure class="label label-default">From $130</figure>
                                    <figure class="location"><i class="fa fa-map-marker"></i>Venice</figure>
                                    <hr>
                                    <div class="count-down" data-countdown-year="2017" data-countdown-month="6" data-countdown-day="21"></div>
                                    <a href="detail.html" class="btn btn-default btn-framed btn-rounded">View Detail</a>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="item" data-id="15">
                            <figure class="circle featured sale">-15%</figure>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="item" data-id="3">
                            <figure class="circle featured sale">-43%</figure>
                            <figure class="ribbon">Top</figure>
                            <a href="detail.html">
                                <div class="description">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="item" data-id="4">
                            <figure class="circle featured sale">-28%</figure>
                            <a href="detail.html">
                                <div class="description">
                    ...
                    <div class="col-md-5 col-sm-5">
                        <div class="item" data-id="6">
                            <figure class="circle featured sale">-45%</figure>
                            <a href="detail.html">
                                <div class="description">
            ...
            <div class="gallery featured">
                <div class="owl-carousel" data-owl-items="6" data-owl-loop="1" data-owl-auto-width="1" data-owl-nav="1" data-owl-dots="1" data-owl-nav-container="#gallery-nav">
                    ...
                    <div class="item featured" data-id="3">
                        <figure class="circle featured sale">-87%</figure>
                        <a href="detail.html">
                            <div class="description">
                                <figure>
                    ...
                    <div class="item featured" data-id="4">
                        <figure class="circle featured sale">-36%</figure>
                        <a href="detail.html">
                            <div class="description">
                                <figure>Average Price: $8 - $30</figure>
                                <div class="label label-default">Lounge</div>
                    ...
                    <div class="item featured" data-id="6">
                        <figure class="circle featured sale">-70%</figure>
                        <a href="detail.html">
                            <div class="description">
                                <div class="label label-default">Event</div>
                                <h3>Stand Up Show</h3>
                    ...
                    <div class="item featured" data-id="8">
                        <figure class="circle featured sale">-55%</figure>
                        <a href="detail.html">
                            <div class="description">
                    ...
                    <div class="item featured" data-id="5">
                        <figure class="circle featured sale">-20%</figure>
                        <a href="detail.html">
                            <div class="description">
                    ...
                    <!--end item-->
                    <div class="item featured" data-id="1">
                        <figure class="circle featured sale">-65%</figure>
                        <a href="detail.html">
                            <div class="description">
                ...
                <div class="row">
                    <div class="col-md-9 col-sm-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-5">
                                <div class="item" data-id="3">
                                    <figure class="circle featured sale">-32%</figure>
                                    <figure class="ribbon">Top</figure>
                                    <a href="detail.html">
                                        <div class="description">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="item" data-id="4">
                                    <figure class="circle featured sale">-40%</figure>
                                    <a href="detail.html">
                                        <div class="description">
                                            <div class="label label-default">Lounge</div>
                                            <h3>Cosmopolit</h3>
